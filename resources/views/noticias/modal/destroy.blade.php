    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Tem certeza que deseja deletar esta notícia?</h3>
                <form id="delete-noticia-form" action="{{ route('noticias.destroy', $noticia->id) }}" method="POST" class="inline">
                    @csrf
                    @method('DELETE')
