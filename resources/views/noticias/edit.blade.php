                    ...
                    <form action="{{ route('noticias.update', $noticia->id) }}" method="POST" enctype="multipart/form-data" id="editNoticiaForm">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="10" placeholder="Escreva o conteúdo da Notícia"
                                      class="dark:text-white text-black mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 rounded-md shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">{{ old('description', $noticia->description) }}</textarea>
