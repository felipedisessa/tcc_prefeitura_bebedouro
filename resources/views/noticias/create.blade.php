                ...
                <div class="p-6 bg-white dark:bg-gray-800">
                    <form action="{{ route('noticias.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Título da Noticia"
                            ...
                            @error('name')
                            <p class="text-red-500 text-xs mt-1">{{ 'O campo nome e obrigatório' }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @error('description')
                            <p class="text-red-500 text-xs mt-1">{{ 'O campo descrição e obrigatório' }}</p>
                            @enderror
                        </div>

                        <div class="mb-4">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="noticia_image">Escolher Imagem</label>
                        <input id="noticia_image" name="noticia_image" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file">
                        </div>
